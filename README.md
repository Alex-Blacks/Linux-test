...
echo "hello" >> text.txt - ">>" Запишет вывод в файл, если его нет он его создаст, если есть то дополнит
ls test 2> error.log - "2>" Запишет вывод ошибки в файл, если его нет он его создаст, если есть то перезапишет
ls test 2>> error.log - "2>>" Запишет вывод ошибки в файл, если его нет он его создаст, если есть то дополнит
ls -l test non_file &> combined.log - "&>"Запишет вывод и текста и ошибки в файл, если его нет он его создаст, если есть то перезапишет
ls -l test non_file &>> combined.log - "&>>"Запишет вывод и текста и ошибки в файл, если его нет он его создаст, если есть то дополнит
